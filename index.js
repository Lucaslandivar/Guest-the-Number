...
console.log(chalk.green("1. Fácil (números de 1 a 10)"));
console.log(chalk.yellow("2. Médio (números de 1 a 50)"));
console.log(chalk.red("3. Difícil (números de 1 a 100)"));

const level = parseInt(readline.question("Insira o seu nível de dificuldade (1, 2 ou 3):"));
...
if(level === 1) {
    ...
    console.log("Nível de dificuldade inválido, começando com o nível fácil.");
    maxNumber = 10;
}
